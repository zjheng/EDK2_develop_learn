...
#define STACK_COOKIE_VALUE 0xC5F725525DAE3CB6ULL
...
#define _PCD_TOKEN_PcdCapsuleFmpSupport  0U
#define _PCD_SIZE_PcdCapsuleFmpSupport 1
#define _PCD_GET_MODE_SIZE_PcdCapsuleFmpSupport  _PCD_SIZE_PcdCapsuleFmpSupport 
#define _PCD_VALUE_PcdCapsuleFmpSupport  0U
extern const  BOOLEAN  _gPcd_FixedAtBuild_PcdCapsuleFmpSupport;
#define _PCD_GET_MODE_BOOL_PcdCapsuleFmpSupport  _gPcd_FixedAtBuild_PcdCapsuleFmpSupport
//#define _PCD_SET_MODE_BOOL_PcdCapsuleFmpSupport  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

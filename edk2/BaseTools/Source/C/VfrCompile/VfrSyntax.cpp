 ...
 *
 *   D:\develop\EDK2\edk2\BaseTools\Bin\Win32\antlr.EXE -CC -e3 -ck 3 -k 2 -fl VfrParser.dlg -ft VfrTokens.h -o . VfrSyntax.g
 *
 */
...
EfiVfrParser::pragmaPackStackDef(void)
{
 ...
 consume();
  ...
  {
    if ( (LA(1)==157) && (LA(2)==StringIdentifier)
 ) {
      zzmatch(157); consume();
...
EfiVfrParser::vfrStatementVarStoreEfi(void)
{
 ...
 consume();
  {
    if ( (LA(1)==Name) && (LA(2)==168) && (LA(3)==StringIdentifier) ) {
      zzmatch(Name); consume();
      zzmatch(168); consume();
      zzmatch(StringIdentifier);
      SN = (ANTLRTokenPtr)LT(1);
...
EfiVfrParser::vfrStatementStaticText(void)
{
 ...
 consume();
  zzmatch(CloseParen); consume();
  {
    if ( (LA(1)==157) && (LA(2)==Text) && (LA(3)==168) ) {
      zzmatch(157); consume();
      zzmatch(Text); consume();
      zzmatch(168); consume();
      zzmatch(169); consume();
...
EfiVfrParser::vfrStatementString(void)
{
 ...
 consume();
  ...
  zzmatch(157);
  _GET_CURRQEST_VARTINFO().mVarType = EFI_IFR_TYPE_STRING;
 consume();
  {
    if ( (LA(1)==FLAGS)
 ) {
...
EfiVfrParser::vfrStatementStatTagList(void)
{
  ...
  vfrStatementStatTag();
  {
    while ( (LA(1)==157) && (setwd33[LA(2)]&0x8) && (setwd33[LA(3)]&0x10) ) {
      zzmatch(157); consume();
      vfrStatementStatTag();
    }
  }
...
EfiVfrParser::vfrStatementInconsistentIf(void)
{
 ...
 consume();
  {
    if ( (LA(1)==162) && (setwd34[LA(2)]&0x4) && !( LA(1)==162 && LA(2)==1) ) {
      zzmatch(162); consume();
    }
    else {
...
EfiVfrParser::vfrStatementWarningIf(void)
{
 ...
 consume();
  {
    if ( (LA(1)==162) && 
(setwd35[LA(2)]&0x40) && !( LA(1)==162 && LA(2)==1) ) {
      zzmatch(162); consume();
    }
    else {
...
EfiVfrParser::vfrStatementSuppressIfQuest(void)
{
 ...
 consume();
  {
    if ( (LA(1)==162) && (setwd37[LA(2)]&0x10) && !( LA(1)==162 && LA(2)==1) ) {
      zzmatch(162); consume();
    }
    else {
...
EfiVfrParser::vfrStatementGrayOutIfQuest(void)
{
 ...
 consume();
  {
    if ( (LA(1)==162) && (setwd38[LA(2)]&0x4) && !( LA(1)==162 && LA(2)==1) ) {
      zzmatch(162); consume();
    }
    else {
      if ( (setwd38[LA(1)]&0x8) && 
